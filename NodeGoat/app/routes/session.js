...
function SessionHandler(db) {
        ...
        userDAO.validateLogin(userName, password, (err, user) => {
            ...
            if (err) {
                if (err.noSuchUser) {
                    ...
                    // TODO:Log Injection - encode/sanitize input for CRLF Injection
                    ...
                    return res.render("login", {
                        ...
                        //TODO:Broken Auth - Uses identical error for both username, password error
    ...
    const validateSignup = (userName, firstName, lastName, password, verify, email, errors) => {
        ...
        //TODO:Broken Authentication -  requires stronger password
